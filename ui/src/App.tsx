  ...
  return (
      <div className="h-full">
        ...
        <div className="container pt-24 md:pt-36 mx-auto flex flex-wrap flex-col md:flex-row items-center">
          ...
          { !data && <div><h1 className="my-4 text-3xl md:text-5xl text-white opacity-75 font-bold leading-tight text-center md:text-left">
            ...
            <p className="leading-normal text-base md:text-2xl mb-8 text-center md:text-left text-white">
              Upload an image on the right and we'll create an add automatically for you!
            </p></div> }
            ...
            { data && <div>
              ...
              <h2 className="text-2xl text-white">Prediction</h2>
              <span className="text-white">Brand: {data.brand}</span><br/>
              <span className="text-white">Model: {data.brand}</span> <br/>
              <span className="text-white">Confidence: {data.confidence}</span>
            </div> }
